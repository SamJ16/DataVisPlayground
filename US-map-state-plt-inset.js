...
function clicked(d) {
    ...
    console.log("clicked() pre click: zoomed = " + zoomed);
    zoomed = true;
    console.log("clicked() post click: zoomed = " + zoomed);
    ...
    function declicked() {
        console.log("declicked() pre click: zoomed = " + zoomed);
        if (zoomed) {
            svg_choropleth.remove("path");
            svg_choropleth.selectAll("circle").remove();
            svg_choropleth.remove("g");
            svg_choropleth.remove("g");
            zoomed = false;
        }
        console.log("declicked() post click: zoomed = " + zoomed);
    }
});